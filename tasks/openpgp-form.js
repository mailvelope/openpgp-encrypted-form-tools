...
module.exports = function(grunt) {
  ...
  // main
  grunt.registerMultiTask('openpgp-form', 'Generate a signed OpenPGP form tag (Experimental)', function() {
    ...
    this.files.forEach(file => {
      ...
      const asyncTask = signMessage(html, options)
      .then(signature => formatTag(signature, html))
